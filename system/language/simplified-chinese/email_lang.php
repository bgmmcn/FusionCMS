...
$lang['email_must_be_array'] = '邮箱验证方法必须传递一个数组。';
$lang['email_invalid_address'] = '无效的邮箱地址：%s';
$lang['email_attachment_missing'] = '无法找到以下邮箱附件：%s';
...
$lang['email_send_failure_phpmail'] = '无法使用 PHP mail() 发送邮箱。您的服务器可能未配置为使用此方法发送邮件。';
$lang['email_send_failure_sendmail'] = '无法使用 PHP Sendmail 发送邮箱。您的服务器可能未配置为使用此方法发送邮件。';
$lang['email_send_failure_smtp'] = '无法使用 PHP SMTP 发送邮箱。您的服务器可能未配置为使用此方法发送邮件。';
...
$lang['email_no_smtp_unpw'] = '错误：您必须分配 SMTP 账号和密码。';
$lang['email_failed_smtp_login'] = '发送 AUTH LOGIN 命令失败。错误：%s';
$lang['email_smtp_auth_un'] = '账号验证失败。错误：%s';
