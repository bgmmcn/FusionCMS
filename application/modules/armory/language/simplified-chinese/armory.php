 ...
 */
 ...
 $lang['search_headline'] = "装备库搜索";
 $lang['search_placeholder'] = "搜索角色、物品和公会...";
 $lang['search_button'] = "搜索";
 $lang['search_too_short'] = "搜索关键词至少需要3个字符！";
 $lang['characters'] = "角色";
 $lang['items'] = "物品";
 $lang['guilds'] = "公会";
 $lang['no_characters_found'] = "未找到角色";
 $lang['no_items_found'] = "未找到物品";
 $lang['no_guilds_found'] = "未找到公会";
 $lang['name'] = "名称";
 $lang['faction'] = "阵营";
 $lang['members'] = "成员";
 $lang['owner'] = "会长";
 ...
 $lang['required'] = "需求等级";
 $lang['type'] = "类型";
 $lang['view_character_profile'] = "查看角色档案";
 $lang['cant_be_empty'] = "搜索内容不能为空！";
 $lang['misc'] = "其他";
